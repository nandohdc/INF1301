...
static const char RETORNA_MORTO_CMD		  [ ] = "=retornamorto"	;
...
TST_tpCondRet TST_EfetuarComando(char * ComandoTeste)
{
	...
	else if (strcmp(ComandoTeste, RETORNA_MORTO_CMD) == 0)
	{
				numLidos = LER_LerParametros("i", &CondRetEsperada);
		...
		CondRetRecebida = MOR_retornaMorto(Morto, &pPilha2);

		return TST_CompararInt(CondRetEsperada, CondRetRecebida, "Erro ao retornar a pilha do morto");

	} /* fim ativa: Testar retornaMorto */
